...
<div class="action-buttons space-x-3">
    ...
    <button class="btn btn-round" disabled={!branchBackAvailable} title="ReturnBack">
		<svg class="icon-outline" fill="none" height="24" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
