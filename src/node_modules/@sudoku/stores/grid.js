  ...
  return {
    ...
    set: (pos, value) => {
      strategyGrid.update($strategyGrid => {
        if (!$strategyGrid[pos.y][pos.x].validate(value)) { return  $strategyGrid; }

        $strategyGrid[pos.y][pos.x].candidates = [value];
        $strategyGrid[pos.y][pos.x].add(timeStep, null);
        return $strategyGrid;
      });
    },

    setCandidates: (pos, strategies) => {
      strategyGrid.update($strategyGrid => {
        $strategyGrid[pos.y][pos.x].add(timeStep, strategies);
      })
    },
